 ...
 * @time 13:55
 */
public class ThreePictureViewHolder extends  BaseViewHolder {
    ...
    public ThreePictureViewHolder(View view) {
        ...
        img2 = view.findViewById(R.id.rv_item_news_img_2);
        img3 = view.findViewById(R.id.rv_item_news_img_3);
    }
}
