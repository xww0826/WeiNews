 ...
 * @time 16:10
 */
public class RecreationNewsFragment extends BaseFragment implements NewsContract.NewsView, SwipeRefreshLayout.OnRefreshListener {
    ...
    protected void initViews(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        srlNews.setOnRefreshListener(this);srlNews.setColorSchemeColors(getResources().getColor(R.color.colorPrimary));
    ...
    @Override
    protected void loadLazyData() { mPresenter.getNewsData("yule");
    }
