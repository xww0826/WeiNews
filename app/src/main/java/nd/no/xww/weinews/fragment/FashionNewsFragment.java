 ...
 * @time 16:10
 */
public class FashionNewsFragment extends BaseFragment implements NewsContract.NewsView, SwipeRefreshLayout.OnRefreshListener {
    ...
    protected void loadLazyData() {
        mPresenter.getNewsData("shishang");
    }
