 ...
 * @time 16:10
 */
public class FinanceNewsFragment extends BaseFragment implements NewsContract.NewsView, SwipeRefreshLayout.OnRefreshListener {
    ...
    protected void loadLazyData() {
        mPresenter.getNewsData("caijing");
    }
